  ...
  public: {
    Tables: {
      book_authors: {
        ...
        Relationships: [
          {
            foreignKeyName: "book_authors_ebook_id_fkey"
            columns: ["ebook_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "book_authors_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
      ...
      book_submissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "book_submissions_ebook_id_fkey"
            columns: ["ebook_id"]
            isOneToOne: false
            referencedRelation: "ebooks"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "book_submissions_reviewer_id_fkey"
            columns: ["reviewer_id"]
            isOneToOne: false
